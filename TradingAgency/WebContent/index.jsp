...
<body>
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img class="d-block w-100"
					src="img/%ED%85%8C%EC%8A%A4%ED%8A%B81.JPG" alt="첫번째 슬라이드">
			</div>
			<div class="carousel-item">
				<img class="d-blockw-100" src="img/%ED%85%8C%EC%8A%A4%ED%8A%B82.JPG"
					alt="두번째 슬라이드">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100"
					src="img/%ED%85%8C%EC%8A%A4%ED%8A%B83.JPG" alt="세번째 슬라이드">
			</div>
		</div>
	...
	<section id="newProductSec"> <!--  반응형 고정  -->
	...
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				<div class="shadow">
					<img src="img/%ED%85%8C%EC%8A%A4%ED%8A%B83.JPG" width="250"
						height="250">
				</div>
			</div>
			<div class="col-md-4">
				<div class="shadow">
					<img src="img/%ED%85%8C%EC%8A%A4%ED%8A%B82.JPG" width="250"
						height="250">
				</div>
			</div>
			<div class="col-md-4">
				<div class="shadow">
					<img src="img/%ED%85%8C%EC%8A%A4%ED%8A%B81.JPG" width="250"
						height="250">
