...
<body>
    <div class="content">
        ...
        <div id="headerDetailGroup">
            ...
            <div id="logoarea">
                <img id="logoimg" src="../../img/logo.jpg" height="120px" width="270px" alt="셀프이미지"; />
            </div>
            <div id="middleTwoBox"> 
                <div id="headerTitle"> <!--중간 첫번째 윗부분-->
                     <div> <a href="">LOGIN</a></div>
                     <div> <a href="">JOIN</a></div>
                     <div> <a href="">CART</a></div>
                     <div> <a href="">ORDER</a></div>
                     <div> <a href="">MYPAGE</a></div>
                     <div> <a href="">CSCENTER</a></div>
                     <div> <a href="" id="bookmark">+BOOKMARK</a></div>
                </div>
                <div id="searchBox">
                    <form action="#" method="get">
                       ...
                       <div id="searchIcon">
                           <input type="submit" value="" class="inputImg"  style="BACKGROUND-COLOR: #FFFFFF">
                       </div>
                    </form>
                </div>
            </div> 
