...
<body>
	<center>
		...
		<div id="wrapper">
				...
				<div id="categoryBorder">
					<div id="categoryType">
						...
						<div class="categoryTitleList">
							...
							<a class="category-btn" onclick="selectCategoryMulti(this);">유람선
								티켓 </a>
						</div>
					</div>
					<div id="productState">
						...
						<div class="imgWrapper">
							...
							<div class="productCoverExplain">
								...
								<ul>
									...
									<li style="color: gray; overflow: auto;">제품설명1<br>
										제품설명2
									</li>
									<li style="color: white; overflow: auto;"><s>￦ 50,000</s>->
										￦ 40,000</li>
								</ul>
							</div>
			...
			<hr>
			<footer id="footer"> 
			<%@include file="../../views/common/footer.jsp"%> </footer>
		</div>
	</center>
</body>
</html>