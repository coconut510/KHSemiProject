                 ...
                 for (var i = 0; i < countFiles; i++) 
                 {
                   ...
                   reader.onload = function(e) {
                      ...
                      imgFile_Suc_One.attr('src',e.target.result);
                       ...
                       var image = $('#.fileUpload1').attr('value');
                        alert(image);
                   }
		...
		<div class="dataWrapper">
			...
			<div class="dataCon">
				<div id="dataInsert">
					...
					<form action="/productInsert" method="post">
						<div class="form-row">
							...
							<div class="form-group col-md-3">
								<label id="subTitle">카테고리</label><span id="bCateCheck"></span> <select
									name="bCategory" id="bCategory" class="form-control"
							...
							<div class="form-group col-md-4">
								<label id="subTitle">상품 상태</label> <select name="productState"
									id="inputState" class="form-control" onchange="state">
							...
							<div class="form-group col-md-4">
								<label id="subTitle">구입날짜</label> <input name="buyDate"
							...
							<div class="form-group col-md-7">
								<label id="subTitle">구입처</label> <input name="purchasing"
									type="text" id="purchasing" class="form-control">
							</div>
						...
						<div class="form-row">
							...
							<div class="imgCon">
								<div id="wrapper" style="margin-top: 20px;">
									...
									<input name="preview1" id="fileUpload1" type="file"
										style="display: none" /> <img
										src="../../img/imgInsertBackground.png" width="150"
										height="150" id="imgFile_Main1"
										onclick="document.all.fileUpload1.click();"> <input
										name="preview2" id="fileUpload2" type="file"
										style="display: none" /> <img
										src="../../img/imgInsertBackground.png" width="150"
										height="150" id="imgFile_Main2"
										onclick="document.all.fileUpload2.click();"> <input
										name="preview3" id="fileUpload3" type="file"
										style="display: none" /> <img
										src="../../img/imgInsertBackground.png" width="150"
										height="150" id="imgFile_Main3"
										onclick="document.all.fileUpload3.click();"> <input
										name="preview4" id="fileUpload4" type="file"
										style="display: none" /> <img
										src="../../img/imgInsertBackground.png" width="150"
										height="150" id="imgFile_Main4"
										onclick="document.all.fileUpload4.click();"> <input
										name="preview5" id="fileUpload5" type="file"
										style="display: none" /> <img
										src="../../img/imgInsertBackground.png" width="150"
										height="150" id="imgFile_Main5"
										onclick="document.all.fileUpload5.click();">
					...
					<form action="/productInsert" method="post"></form>
					<div class="howSubmit">
